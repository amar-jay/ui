const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./_virtual_cosmos-imports-D4YHqr4Q.js","./_virtual_cosmos-imports-B5mVZ8u6.css"])))=>i.map(i=>d[i]);
...
function pickSerializableValues(object) {
  return Object.fromEntries(Object.entries(object).filter(([k2, v2]) => isSerializable(v2)));
}
...
function DecoratedFixture({ fixture, fixtureOptions, userDecoratorModules, globalDecorators: globalDecorators2 = [] }) {
  return reactExports.useMemo(() => {
    const decorators = [
      ...globalDecorators2,
      ...userDecoratorModules.map((m2) => m2.default).flat()
    ];
...
async function mount() {
  const args = await __vitePreload(() => import("./_virtual_cosmos-imports-D4YHqr4Q.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
